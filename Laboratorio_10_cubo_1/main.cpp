...
int main(){
    ...
    Shader ourShader("C:/Users/aconc/Desktop/Computacion Grafica/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Laboratorio_10_cubo_1/vertexShader.glsl", "C:/Users/aconc/Desktop/Computacion Grafica/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Laboratorio_10_cubo_1/fragmentShader.glsl");
    ...
    glm::vec3 colors[6] = {
        ...
        glm::vec3(0.73, 0.02, 0.02), 
        glm::vec3(0.96, 0.46, 0.14), 
        glm::vec3(0.02, 0.37, 0.68), 
        glm::vec3(0.29, 0.68, 0.02), 
        glm::vec3(0.89, 0.69, 0.03), 
    };
